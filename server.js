...
// outras rotas intermediárias (unir-videos, comprimir-videos, embaralhar-videos, remover-audio, criar-video-automatico, extrair-audio, transcrever-audio, extrair-frames) seguem iguais…
// (mantive para não alongar demais aqui, já que você pediu a correção principal)
...
app.post('/mixar-video-turbo', upload.single('narration'), async (req, res) => {
    ...
    try {
        ...
        // ✅ CORREÇÃO: última imagem sem "duration"
        let fileContent = "";
